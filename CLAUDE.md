...
## Session start
- At the start of every session, read the learning log in PROGRESS.md to see which week I'm on
  and what I found confusing last time.
...
- Week 0: Setup — JDK 21, IntelliJ IDEA, Git, GitHub, Hello World.
- Week 1: Java basics — variables, data types, input/output, if/else. Project: tip calculator or unit converter.
- Week 2: Loops and methods. Project: number-guessing game.
- Week 3: Arrays, ArrayList, HashMap. Project: student grade manager.
- Week 4: OOP — classes, objects, constructors, encapsulation. Project: grade manager rebuilt with a Student class.
- Week 5: Dart basics. Project: grade manager rewritten in Dart.
- Week 6: Flutter setup, widgets, layouts. Project: profile/business-card app.
- Week 7: User input, state, navigation. Project: to-do list app.
- Weeks 8–9: Local storage and calling a public API. Project: polished weather or expense-tracker app.

## After graduation
- Months 3–5: Spring Boot, SQL databases, REST APIs.
- Months 6–8: Full-stack project — Flutter app connected to my own Spring Boot backend, with login and cloud deployment.
- Months 9–12: Advanced state management, testing, Docker, and broader engineering skills.